...
| --- | --- | --- | --- | --- | ---: | --- | --- | --- | --- |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `source_revision` | 1608555600000 | `high` | `22665.35000000` | `22774.00000000` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `source_revision` | 1608555600000 | `close` | `22646.53000000` | `22681.32000000` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `source_revision` | 1608555600000 | `volume` | `2830.34558700` | `3685.45440500` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `source_revision` | 1608555600000 | `close_time` | `1608559199999` | `1608558440521` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `source_revision` | 1608555600000 | `quote_volume` | `63790349.91077578` | `83180713.81558070` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `source_revision` | 1608555600000 | `trade_count` | `44795` | `62654` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `source_revision` | 1608555600000 | `taker_buy_base_volume` | `1428.55237100` | `1815.00048700` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `source_revision` | 1608555600000 | `taker_buy_quote_volume` | `32189044.97410345` | `40955894.79935769` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2020-12` | `timestamp_mismatch` | 1608559200000 | `open_time` | `1608559200000` | `` | ZIP-only timestamp is absent from the selected and adjacent official REST scopes |
| `local` | `spot_klines` | `BTCUSDT` | `2021-04` | `source_revision` | 1619139600000 | `close` | `51080.59000000` | `51048.59000000` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2021-04` | `source_revision` | 1619139600000 | `volume` | `11667.63216200` | `11815.24808200` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2021-04` | `source_revision` | 1619139600000 | `quote_volume` | `593144862.93087132` | `600681216.08495300` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2021-04` | `source_revision` | 1619139600000 | `trade_count` | `276379` | `279380` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2021-04` | `source_revision` | 1619139600000 | `taker_buy_base_volume` | `5428.08513400` | `5505.78496500` | official sources contain different canonical values |
| `local` | `spot_klines` | `BTCUSDT` | `2021-04` | `source_revision` | 1619139600000 | `taker_buy_quote_volume` | `276430919.50983045` | `280397730.73104759` | official sources contain different canonical values |
...
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `source_revision` | 1608555600000 | `high` | `608.82000000` | `613.29000000` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `source_revision` | 1608555600000 | `close` | `608.31000000` | `610.45000000` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `source_revision` | 1608555600000 | `volume` | `26146.58875000` | `34927.37209000` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `source_revision` | 1608555600000 | `close_time` | `1608559199999` | `1608558440528` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `source_revision` | 1608555600000 | `quote_volume` | `15866207.11148880` | `21219132.19507340` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `source_revision` | 1608555600000 | `trade_count` | `14393` | `19857` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `source_revision` | 1608555600000 | `taker_buy_base_volume` | `14284.12764000` | `19843.88555000` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `source_revision` | 1608555600000 | `taker_buy_quote_volume` | `8669079.80611710` | `12059602.91269320` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2020-12` | `timestamp_mismatch` | 1608559200000 | `open_time` | `1608559200000` | `` | ZIP-only timestamp is absent from the selected and adjacent official REST scopes |
| `local` | `spot_klines` | `ETHUSDT` | `2021-04` | `source_revision` | 1619139600000 | `close` | `2325.82000000` | `2321.44000000` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2021-04` | `source_revision` | 1619139600000 | `volume` | `187368.61418000` | `188766.41365000` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2021-04` | `source_revision` | 1619139600000 | `quote_volume` | `436821371.55040100` | `440066845.48382460` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2021-04` | `source_revision` | 1619139600000 | `trade_count` | `181462` | `182900` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2021-04` | `source_revision` | 1619139600000 | `taker_buy_base_volume` | `84489.57317000` | `85129.16935000` | official sources contain different canonical values |
| `local` | `spot_klines` | `ETHUSDT` | `2021-04` | `source_revision` | 1619139600000 | `taker_buy_quote_volume` | `196993734.15928340` | `198479364.97862700` | official sources contain different canonical values |
