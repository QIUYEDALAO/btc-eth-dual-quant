...
| `reports/m1/T3_UNIFIED_METRICS_AND_POLICY_BENCHMARK_REPORT.md` | T3 unified metrics and policy benchmark | pass_pending_pr_ci_merge | Records the single daily-MTM convention, fixed policy benchmark, PSR/DSR and diagnostics coverage, and sealed expert M1C regression. | no |
