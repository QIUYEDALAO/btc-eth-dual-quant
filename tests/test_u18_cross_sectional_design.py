...
from scripts.u18_cross_sectional_design_check import CONTENT_HASH, SCOPE, validate_scope


class U18DesignTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_failure_or_nonduplication_removal_fails(self):
        ...
        self.assertTrue(validate_scope(scope))
        scope = copy.deepcopy(self.scope)
        scope["non_duplication"]["u17_liquidity_risk_premium_prohibited"] = False
        self.assertTrue(validate_scope(scope))
