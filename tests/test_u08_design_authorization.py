...
from scripts.u08_design_authorization_check import AUDIT,DECISION,EXPECTED_HASH,RESULTS,validate
class U08DesignAuthorizationTests(unittest.TestCase):
 def setUp(self):
 ...
 def test_only_design_is_authorized(self):self.assertEqual([k for k,v in self.d["authorizations"].items() if v],["u08_hypothesis_design"])
