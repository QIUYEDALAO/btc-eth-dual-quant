...
from scripts.u12_cross_sectional_design_check import CONTENT_HASH, SCOPE, load, validate_scope


class U12DesignTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_removing_invariant_or_failure_fails(self):
        changed = copy.deepcopy(self.document)
        changed["causal_and_membership_invariants"].pop("calendar_state_definition_must_be_frozen_before_data_access")
