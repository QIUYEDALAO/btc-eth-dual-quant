...
from scripts.u06_cross_sectional_paper_protocol_review_check import REVIEW_PATH,load,validate,validate_report
class U06PaperProtocolReviewTests(unittest.TestCase):
