...
from scripts.u24_design_authorization_check import AUDIT,DECISION,FAILURE,PRIOR,validate
class U24AuthorizationTests(unittest.TestCase):
 def setUp(self):
 ...
 def test_inversion_or_escalation_tamper(self):
  x=copy.deepcopy(self.d);x["decision"]["u23_negative_result_inversion_repair_relabeling_or_repackaging_prohibited"]=False;self.assertTrue(validate(x,self.f,self.p,self.a))
