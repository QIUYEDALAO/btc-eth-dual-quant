...
from scripts.u22_cross_sectional_design_check import CONTENT_HASH, SCOPE, validate_scope


class U22DesignTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_failure_or_nonduplication_removal_fails(self):
        ...
        self.assertTrue(validate_scope(changed))
        changed = copy.deepcopy(self.scope)
        changed["non_duplication"]["u21_systematic_cokurtosis_risk_premium_prohibited"] = False
        self.assertTrue(validate_scope(changed))
