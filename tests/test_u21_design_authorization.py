...
from scripts.u21_design_authorization_check import AUDIT, DECISION, FAILURE, PRIOR, validate


class U21AuthorizationTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_inversion_or_escalation_tamper(self):
        ...
        decision["decision"]["u20_negative_result_inversion_repair_relabeling_or_repackaging_prohibited"] = False
