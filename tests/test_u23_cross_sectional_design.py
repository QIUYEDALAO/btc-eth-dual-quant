...
from scripts.u23_cross_sectional_design_check import CONTENT_HASH, SCOPE, validate_scope


class U23DesignTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_failure_or_nonduplication_removal_fails(self):
        ...
        self.assertTrue(validate_scope(changed))
        changed = copy.deepcopy(self.scope)
        changed["non_duplication"]["u22_dispersion_expansion_leader_continuation_prohibited"] = False
        self.assertTrue(validate_scope(changed))
