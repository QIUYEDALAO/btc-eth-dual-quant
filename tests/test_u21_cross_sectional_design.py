...
from scripts.u21_cross_sectional_design_check import CONTENT_HASH, SCOPE, validate_scope


class U21DesignTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_failure_or_nonduplication_removal_fails(self):
        ...
        self.assertTrue(validate_scope(changed))
        changed = copy.deepcopy(self.scope)
        changed["non_duplication"]["u20_negative_coskewness_risk_premium_prohibited"] = False
        self.assertTrue(validate_scope(changed))
