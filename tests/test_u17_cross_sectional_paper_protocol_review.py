...
from scripts.u17_cross_sectional_paper_protocol_review_check import EXPECTED, REVIEW, validate


class U17ReviewTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_target_or_dimension_tamper(self):
        ...
        review = copy.deepcopy(self.review)
        review["review_dimensions"]["twenty_one_of_twenty_eight_persistence"] = "fail"
        self.assertTrue(validate(review))
