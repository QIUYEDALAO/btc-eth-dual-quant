...
from scripts.u19_cross_sectional_paper_protocol_review_check import EXPECTED, REVIEW, validate


class U19ReviewTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_target_or_dimension_tamper(self):
        ...
        review = copy.deepcopy(self.review)
        review["review_dimensions"]["two_half_cross_sectional_top_quarter_persistence"] = "fail"
        self.assertTrue(validate(review))
