...
from scripts.u10_cross_sectional_paper_protocol_review_check import E,REPORT,validate
class U10ProtocolReviewTests(unittest.TestCase):
 ...
 def test_permission_escalation_fails(self):d=copy.deepcopy(self.d);d["authorizations"]["event_scan"]=True;self.assertTrue(validate(d,self.t))
