...
from scripts.u12_cross_sectional_paper_protocol_review_check import EVIDENCE, REPORT, validate


class U12ProtocolReviewTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_dimension_or_permission_escalation_fails(self):
        changed = copy.deepcopy(self.document)
        changed["dimensions"]["same_reader_implementation_data_scope_preflight"] = "fail"
