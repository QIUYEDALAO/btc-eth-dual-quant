...
from scripts.u23_cross_sectional_data_qualification import CONFIG
from scripts.u23_cross_sectional_data_qualification_check import RESULT,validate
class U23QualificationTests(unittest.TestCase):
 ...
 def test_ceiling_isolation_or_permission_tamper(self):
  ...
  x=copy.deepcopy(self.result);x["isolation"]["range_rows_generated"]=1;self.assertTrue(validate(self.config,x))
