...
TARGET_SHA="cd4a1d8fb53870cdf8a3a683a4942a2c81b58f44"
PASS_COUNT=0
FAIL_COUNT=0
RESULTS=()
...
run_check "exact PR #81 target binding" "$PY_CMD" scripts/adr0014_independent_review_check.py --verify-target-ref "$TARGET_SHA"
run_check "ADR-0014 Draft tests at frozen head" reviewed_draft_tests
run_check "independent review tests" "$PY_CMD" -m unittest tests.test_adr0014_independent_review -v
...
run_check "review JSON/hash/report regeneration check" "$PY_CMD" scripts/adr0014_independent_review_check.py
...
echo
echo "ADR-0014 independent review validation summary"
