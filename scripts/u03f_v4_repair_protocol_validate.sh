...
run_check "repair protocol tests" "$PY_CMD" -m unittest tests.test_u03f_v4_repair_protocol -v
run_check "repair protocol checker" "$PY_CMD" scripts/u03f_v4_repair_protocol_check.py
run_check "existing failed-audit evidence" bash scripts/u03f_v4_independent_audit_result_validate.sh
...
echo
echo "U-03F V4 repair protocol validation summary"
