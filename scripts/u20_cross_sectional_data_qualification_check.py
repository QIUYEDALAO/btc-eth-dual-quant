...
from scripts.u20_cross_sectional_data_qualification import CONFIG, canonical_hash

RESULT = ROOT / "reports/m1/evidence/u20_cross_sectional_data_qualification_v1.json"
EXPECTED_CONTRACT = "7bae7234c15f6f378b5b28667d3e805e51a34465bd95c736b0a3ef2109f49f80"
EXPECTED_RESULT = "de61add6f8ef2a22f62166c14aeb4c30565cb8b3003e6395909fa7b7a85e2368"
...
def validate(config: Mapping[str, Any], result: Mapping[str, Any]) -> list[str]:
    ...
    zero_fields = (
        ...
        "common_adjusted_return_rows_generated",
        "coskewness_statistic_rows_generated",
...
def main() -> int:
    ...
    if failures:
        print("u20_cross_sectional_data_qualification_check FAIL")
        for failure in failures:
            print(f"- {failure}")
        return 1
    print(f"u20_cross_sectional_data_qualification_check PASS hash={EXPECTED_RESULT} ceiling=752 complexity=3/3")
    return 0
