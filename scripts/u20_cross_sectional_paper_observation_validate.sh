...
python3 scripts/u20_cross_sectional_paper_observation_check.py
python3 -m unittest -v tests.test_u20_cross_sectional_paper_observation tests.test_u20_cross_sectional_paper_observation_preflight
python3 scripts/u20_cross_sectional_data_qualification_check.py
