...
run_check "M1H paper protocol validation" bash scripts/m1h_paper_protocol_validate.sh
run_check "M1H-03 unit tests" "$PY_CMD" -m unittest tests.test_m1h_funding_qualification tests.test_m1h_paper_feasibility -v
run_check "M1H-03 report/state checker" "$PY_CMD" scripts/m1h03_check.py
...
echo
echo "M1H-03 validation summary"
