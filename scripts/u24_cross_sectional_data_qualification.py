#!/usr/bin/env python3
"""Run U-24 result-free source qualification and structural ceiling."""
...
from scripts.u23_cross_sectional_data_qualification import structural_preflight
CONFIG=ROOT/"config/u24_cross_sectional_data_qualification_v1.json";REVIEW=ROOT/"reports/expert/evidence/u24_cross_sectional_paper_protocol_review_v1.json";FEASIBILITY=ROOT/"reports/m1/evidence/u24_synthetic_core_feasibility_v1.json";CORE=ROOT/"src/btc_eth_dual_quant/data/u24_lottery_demand.py";PROTOCOL_PATH="config/u24_cross_sectional_paper_protocol_v1.json"
