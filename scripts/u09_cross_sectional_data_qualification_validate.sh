...
python3 scripts/u09_cross_sectional_data_qualification_check.py
python3 -m unittest -v tests.test_u09_cross_sectional_data_qualification
python3 scripts/u09_cross_sectional_paper_protocol_review_check.py
