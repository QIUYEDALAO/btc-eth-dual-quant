...
python3 scripts/u15_taker_buy_field_qualification_failure_check.py
python3 -m unittest -v tests.test_u15_taker_buy_field_qualification_failure
python3 scripts/u15_cross_sectional_paper_protocol_review_check.py
