...
run_check "ADR-0015 Draft tests" "$PY_CMD" -m unittest tests.test_adr0015_policy_draft -v
run_check "ADR-0015 Draft checker" "$PY_CMD" scripts/adr0015_policy_draft_check.py
...
echo
echo "ADR-0015 policy Draft validation summary"
