...
ROOT=Path(__file__).resolve().parents[1];E=ROOT/"reports/expert/evidence/u08_cross_sectional_paper_protocol_review_v1.json";REPORT=ROOT/"reports/expert/U08_CROSS_SECTIONAL_PAPER_PROTOCOL_REVIEW.md";TARGET="a516efb32f2058b603918365a6eeaef0fe509361";BASE="579c179";REVIEW="316fe577050555bf0b8c237c6a5bc374885132c863ba647fe2c826971aca8acf"
...
def validate(d:Mapping[str,Any],text:str)->list[str]:
 ...
 if d.get("target_commit")!=TARGET or d.get("target_base_commit")!=BASE or d.get("protocol_content_hash")!="98752a0722383ac582ceecf88cbd3f014a97eb56f9cb8a80fd805c55fa0b0283":f.append("target binding changed")
...
def main()->int:
 ...
 if f:print("u08_cross_sectional_paper_protocol_review_check FAIL");[print(f"- {x}") for x in f];return 1
 print(f"u08_cross_sectional_paper_protocol_review_check PASS target={TARGET} review={REVIEW} approve 0/0");return 0
