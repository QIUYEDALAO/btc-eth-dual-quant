...
python3 scripts/u18_cross_sectional_paper_observation_check.py
python3 -m unittest -v tests.test_u18_cross_sectional_paper_observation
python3 scripts/u18_cross_sectional_data_qualification_check.py
