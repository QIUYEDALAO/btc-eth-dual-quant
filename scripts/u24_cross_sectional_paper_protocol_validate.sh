...
python3 scripts/u24_cross_sectional_paper_protocol_check.py
python3 -m unittest -v tests.test_u24_lottery_demand tests.test_u24_cross_sectional_paper_protocol
python3 scripts/u24_cross_sectional_design_check.py
