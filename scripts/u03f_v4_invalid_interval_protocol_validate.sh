...
run_check "invalid-interval protocol tests" "$PY_CMD" -m unittest tests.test_u03f_v4_invalid_interval_protocol -v
run_check "invalid-interval protocol checker" "$PY_CMD" scripts/u03f_v4_invalid_interval_protocol_check.py
run_check "blocked repair requalification checker" "$PY_CMD" scripts/u03f_v4_repair_requalification_result_check.py
run_check "blocked repair requalification tests" "$PY_CMD" -m unittest tests.test_u03f_v4_repair_requalification_result -v
...
echo
echo "U-03F V4 invalid-interval protocol validation summary"
