...
cd "$ROOT"
PYTHONPATH=.deps:src python3 scripts/u19_cross_sectional_paper_protocol_check.py
PYTHONPATH=.deps:src python3 -m unittest tests.test_u19_cross_sectional_paper_protocol
