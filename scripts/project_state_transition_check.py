...
ALLOWED = {
    (
        "U-14 outcome-blind Paper protocol frozen; exact-head independent review is the only next task",
        "u14_paper_protocol_frozen_pending_exact_head_review_no_data_no_events_no_returns_no_oos_no_trading_no_m2",
    ): "U-14-PROTOCOL-REVIEW",
    (
