...
ALLOWED = {
    ...
    (
        "U-12 Paper protocol frozen before results; exact-head independent review is the only next task",
        "u12_paper_protocol_frozen_pending_exact_head_review_no_data_no_events_no_returns_no_oos_no_trading_no_m2",
    ): "U-12-PROTOCOL-REVIEW",
    (
