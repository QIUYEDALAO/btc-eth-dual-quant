...
ALLOWED = {
    ...
    (
        "U-08 Paper protocol frozen; exact-head independent review is the only authorized next task",
        "u08_paper_protocol_frozen_pending_exact_head_review_no_data_no_events_no_returns_no_oos_no_trading_no_m2",
    ): "U-08-PROTOCOL-REVIEW",
    (
