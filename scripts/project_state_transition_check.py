...
def validate(state: dict) -> list[str]:
    ...
    active.extend(item for item in open_work if item.get("id") in {"U-14-DATA-QUALIFICATION", "U-14-PAPER-OBSERVATION", "U-15-DECISION", "U-15", "U-15-PROTOCOL", "U-15-PROTOCOL-REVIEW", "U-15-DATA-QUALIFICATION", "U-16", "U-16-PROTOCOL", "U-16-PROTOCOL-REVIEW", "U-16-DATA-QUALIFICATION", "U-16-PAPER-OBSERVATION", "U-17", "U-17-PROTOCOL", "U-17-PROTOCOL-REVIEW", "U-17-DATA-QUALIFICATION", "U-18", "U-18-PROTOCOL", "U-18-PROTOCOL-REVIEW", "U-18-DATA-QUALIFICATION", "U-18-PAPER-OBSERVATION", "U-19"})
