...
ALLOWED = {
    ...
    (
        "External-strategy 92-boundary authority frozen pending exact-head review",
        "external_strategy_boundary_authority_frozen_pending_exact_head_review_zero_is_zero_oos_no_trading_no_m2",
    ...
    (
        "ADR-0017 final pre-runtime selection/runtime authorization pending merge",
        "adr0017_frozen_pending_merge_runtime_not_yet_executed_oos_sealed_no_trading_no_m2",
    ): "EXTERNAL-STRATEGY-ADR0017",
    (
...
def validate(state: dict) -> list[str]:
    ...
    active.extend(item for item in open_work if item.get("id") in {"U-14-DATA-QUALIFICATION", "U-14-PAPER-OBSERVATION", "U-15-DECISION", "U-15", "U-15-PROTOCOL", "U-15-PROTOCOL-REVIEW", "U-15-DATA-QUALIFICATION", "U-16", "U-16-PROTOCOL", "U-16-PROTOCOL-REVIEW", "U-16-DATA-QUALIFICATION", "U-16-PAPER-OBSERVATION", "U-17", "U-17-PROTOCOL", "U-17-PROTOCOL-REVIEW", "U-17-DATA-QUALIFICATION", "U-18", "U-18-PROTOCOL", "U-18-PROTOCOL-REVIEW", "U-18-DATA-QUALIFICATION", "U-18-PAPER-OBSERVATION", "U-19", "U-19-PROTOCOL", "U-19-PROTOCOL-REVIEW", "U-19-DATA-QUALIFICATION", "U-19-PAPER-OBSERVATION", "U-20", "U-20-PROTOCOL", "U-20-PROTOCOL-REVIEW", "U-20-DATA-QUALIFICATION", "U-20-PAPER-OBSERVATION", "U-21", "U-21-PROTOCOL", "U-21-PROTOCOL-REVIEW", "U-21-DATA-QUALIFICATION", "U-22", "U-22-PROTOCOL", "U-22-PROTOCOL-REVIEW", "U-22-DATA-QUALIFICATION", "U-22-PAPER-OBSERVATION", "U-23", "U-23-PROTOCOL", "U-23-PROTOCOL-REVIEW", "U-23-DATA-QUALIFICATION", "U-23-PAPER-OBSERVATION", "U-24", "U-24-PROTOCOL", "U-24-PROTOCOL-REVIEW", "U-24-DATA-QUALIFICATION", "U-24-PAPER-OBSERVATION", "U-25-DECISION", "EXISTING-STRATEGY-ROADMAP", "EXTERNAL-STRATEGY-ADR0017", "EXTERNAL-STRATEGY-ADR0018", "EXTERNAL-STRATEGY-IS-DATA-BOUNDARY", "EXTERNAL-STRATEGY-ORIGINAL-IS"})
