...
PYTHONPATH=.deps:src python3 scripts/u21_cross_sectional_paper_protocol_review_check.py
PYTHONPATH=.deps:src python3 -m unittest tests.test_u21_cross_sectional_paper_protocol_review
