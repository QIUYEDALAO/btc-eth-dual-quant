...
- Current phase: PR #83 merged the ADR-0014 review closeout at `ab45ba4`. Draft PR #81 now incorporates MC-01..MC-11 in docs-only structured models and is pending an independent exact-head conformance review. It remains Draft, unadopted and non-runtime.
...
- U-03F must not start while V3 is blocked. U-04 remains unauthorized. Only the independent conformance review of the revised PR #81 head may follow; contracts, registries, qualification artifacts and V3/V4 runs remain prohibited.
