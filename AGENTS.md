...
- U-06 Paper protocol `7b53860efa2a5c52d727f1d4d4694ddf39ff34517dfde6aaf4b6abe31f35f289` is frozen before data/results. Only an independent exact-head review may follow; data, events, returns, OOS and trading remain false.
...
- U-05 is closed. The only current successor is the U-06 Paper protocol exact-head review; no data/event scan is authorized before approval.
