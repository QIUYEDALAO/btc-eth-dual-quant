...
- The fixture-only repair implementation is in Draft PR #98 on `codex/u03f-v4-repair-implementation` with repair hash `3a0a40c26f4132ec2ec57e5a43e4f8438660fbff4767d0187c37b377841d3424`. All six frozen fault tests pass; the future requalification entry is frozen-local-only, and no public requalification or new audit has run.
