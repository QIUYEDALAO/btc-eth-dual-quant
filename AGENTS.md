...
- ADR-0015 conditional adoption is pending PR validation on `codex/adr-0015-conditional-adoption`. Adoption content hash `d9b220657d3867941f4f42fd112339c4058e7bc734aa9db72a5b7f81ac78fc19` binds reviewed semantic body hash `c3d5f605ec26161f1bedc6961ac6f326d00582f9c3dcaa9de68c226961a34149` and all exact evidence identities.
- Conditional adoption authorizes only a separate generic policy implementation, synthetic fixtures, fault injection and later exact-head implementation review. This adoption stage modifies no production pipeline and runs no public data.
...
- The only successor after adoption merge is the separate generic implementation. Any target/hash/semantic/authorization drift fails closed.
