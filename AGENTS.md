...
- Only a separate outcome-blind U-04 paper-protocol design is authorized next. It must freeze all observation/event/Gate choices before any run; protocol execution remains unauthorized.
