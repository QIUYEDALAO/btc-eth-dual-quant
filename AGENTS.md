...
- The only current successor is the U-05 outcome-blind hypothesis design. A separate protocol must be frozen and independently approved before any event scan.
