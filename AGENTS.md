...
- The only current successor is the unique sealed-IS U-05 Paper observation. It may calculate only frozen event/episode/path diagnostics, must be three-order deterministic, and must close the candidate on any failed Gate.
