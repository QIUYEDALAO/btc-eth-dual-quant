...
- U-13 Paper protocol `1cf6dade6e75900278ba5aeee30018d3f0ff93d83d982e212d58033800993288` is frozen before data/results. It fixes the completed positive common shock, 2,160h prior-only lag history, disjoint-half persistence, permanent-weakness exclusion, 24h clustering/path, costs and Paper Gates. Only exact-head independent review is authorized; data, events, paths, returns, strategy/backtesting, OOS, trading and M2 remain false.
