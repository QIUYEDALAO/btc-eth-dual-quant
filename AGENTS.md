...
- U-05 is closed without Paper-result review, fixed rules, strategy, backtest or OOS. The only current successor is a separate decision on whether to authorize one economically independent, outcome-blind next candidate design; U-04/U-05 outcome inversion is prohibited.
