...
- The fixture-only repair implementation is in Draft PR #98 on `codex/u03f-v4-repair-implementation` with repair hash `b3c17ef6b84c0c09798dd7add12ed869622a50963ab7dc99fc8d951bea063c6e`. All six frozen fault tests pass; the future requalification entry is frozen-local-only, and no public requalification or new audit has run.
