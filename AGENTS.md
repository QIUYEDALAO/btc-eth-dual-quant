...
- The only current successor is an independent auditor fixture implementation bound to protocol `9a1768f0...b970b`; it must not use production builders or the production invalid-interval module as its audit algorithm.
