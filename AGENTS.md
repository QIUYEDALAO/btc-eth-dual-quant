...
- The only current successor is a separate governance-only decision whether to authorize U-04 design. U-04 remains unauthorized until that decision is recorded.
