...
- U-05 Paper protocol `c8bd5523e94fc410e6ed4e5a28bb81864ed648d85c9d039ba26aab6dd8bae214` is frozen before outcomes. It fixes completed UTC 4h breadth/common-move events, a 24h connected episode window, 5m diagnostics, sample/concentration Gates and the sealed boundary. Only a separate exact-head independent review is authorized; data, events, paths, returns and OOS remain inaccessible.
...
- The only current successor is the U-05 Paper protocol exact-head independent review. It must approve the immutable target with zero critical/high findings before any data qualification; event scans remain prohibited.
