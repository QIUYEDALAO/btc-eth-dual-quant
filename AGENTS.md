...
- U-05 is closed. The only current successor is a U-06 outcome-blind Paper protocol design; no data/event scan is authorized before separate exact-head review.
