...
- The fixture-only repair implementation is in Draft PR #98 on `codex/u03f-v4-repair-implementation` with repair hash `2a3efe7d6afd1446e87cdac5dcbeba91e758d24f5af8d473abc0a1f3c96d6b41`. All six frozen fault tests pass; the future requalification entry is frozen-local-only, and no public requalification or new audit has run.
