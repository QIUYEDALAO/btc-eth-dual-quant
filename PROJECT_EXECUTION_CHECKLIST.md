...
| Q-01 | Candidate queue governance | in_progress | M1E-03 merged pass | `codex/candidate-queue-common-gates` | Immutable M1E -> M1G -> M1H queue, hypotheses, hashes, DSR trial count, failure transitions and terminal stop | Candidate queue validator, ledger hash checks, context and CI pass | review and merge required; no candidate design authorized |
| Q-02 | Common validation governance | in_progress | Q-01 | `codex/candidate-queue-common-gates` | Fixed costs, sealed OOS, daily-MTM, PSR, drawdown, concentration, benchmark and no-rescue policy | Machine contract rejects lowered Gates or enabled downstream authorization | review and merge required; no backtest or OOS authorized |
