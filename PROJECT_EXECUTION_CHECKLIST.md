...
| M1E-06 | M1E paper feasibility | pending | M1E-05 merged pass | future branch | IS-only frequency, displacement, MAE/MFE, cost-coverage and sample projection | 120/30 projected trades, 1.80% typical displacement and cross-year/cross-symbol evidence | implementation not started; OOS remains sealed |
...
- Authorized work: M1E-06 IS-only paper-feasibility diagnostics. Fixed rules, strategy code, Freqtrade backtesting and OOS remain unauthorized unless M1E-06 passes.
