...
| M1E-06 | M1E paper feasibility | failed_feasibility | M1E-05 merged pass | `codex/m1e-is-paper-feasibility` / PR pending | Frozen protocol, IS-only frequency, displacement, MAE/MFE, cost coverage and sample projection | Projected samples and distribution passed; combined/BTC/ETH median 24h MFE each failed fixed 1.80% Gate | M1E stops before rule contract; OOS remains sealed |
