...
| M1H-03A | M1H public funding-data qualification | completed | M1H-02 merged | `codex/m1h-funding-paper-feasibility` | Public ZIP lineage, per-event interval, settlement continuity and sealed canonical 5m report | Qualification pass with zero conflicting duplicates, invalid intervals, missing settlements or OOS-value parsing | none |
| M1H-03B | M1H sealed-IS paper feasibility | failed_feasibility | M1H-03A pass | `codex/m1h-funding-paper-feasibility` | One frozen funding-tail event/path observation | Fixed sample, close-displacement, year-distribution and invalid-data Gates | Combined/BTC/ETH median 24h close displacement failed 1.80%; 2022 episode share 48.09% exceeded 45% |
