...
| M1E-01 | M1E product/data contract | in_progress | separately approved new trial | `codex/m1e-1h-product-data-contract` | ADR-0008, sealed trial identity, machine-readable contract | Contract, non-reuse, ledger, context, safety and CI pass | strategy/OOS/backtesting remain unauthorized |
