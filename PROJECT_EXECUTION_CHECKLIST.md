...
| T4-01 | Feasibility harness | completed | T3-01 completed | `codex/short-horizon-t4-feasibility-harness` / PR pending | IS-only event decay, fixed costs, frequency, clustering, path risk, occupancy and sample-budget tooling | 169 tests, T4 Validate 10/0, no candidate evaluation, no OOS return access | merge and closeout pending |
