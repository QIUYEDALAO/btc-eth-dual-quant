...
| U-03E-ADJ | Liquid universe V2 source conflict adjudication | in_progress | U-03E truthful blocked evidence merged | `codex/u03e-source-conflict-adjudication` / PR #73 | Checksum-bound raw-row, daily ZIP and two-host public REST evidence | All three conflicts classified; report exactly regenerates; no contract bypass | Decision is `new_policy_adr_required`; same-contract rerun remains unauthorized pending a separately reviewed ADR |
