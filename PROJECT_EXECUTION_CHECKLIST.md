...
| M1E-02 | M1E public-data qualification | blocked | M1E-01 completed | `codex/m1e-1h-public-data-qualification` | Official 5m/1h/4h golden data, parity, quarantine, cache and report | Common six-month data/liquidity qualification and Freqtrade list-data pass | six post-start official OHLCV aggregate/source-conflict months |
