...
| M1H-02 | M1H paper protocol | completed_pending_review | M1H-01 merged pass | `codex/m1h-paper-protocol-freeze` / PR pending | Frozen funding-tail event identity, timing, path observations, close-displacement Gates and leakage prevention | No event/result access; MFE is diagnostic only; protocol checker and CI pass | review and merge pending |
