...
| M1E-04 | M1E economic hypothesis | in_progress | M1E-03 and Q-01/Q-02 merged; user approval granted | `codex/m1e-is-only-rule-design` | IS-only economic hypothesis and non-duplication review | Hypothesis/hash, failure regimes, IS boundary, no M1A rescue, no parameter selection | review and merge required |
